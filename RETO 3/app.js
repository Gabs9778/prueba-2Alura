...
while (contador >= 0) {console.log (contador);
contador = contador -1;
}

// version mas corta y elegante
...
/*3. Crea un programa de cuenta regresiva. Pide un número y cuenta desde 0 hasta ese número utilizando un 
