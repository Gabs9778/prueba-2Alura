...
let mensajeDeBienvenida= " Hola, Bienvenidos a mi programa";
...
let lenguajeDeprogramacion = prompt("¿Cuál es el lenguaje de programación que más te gusta?");
console.log(`El lenguaje de programacion que más me gusta es: ${lenguajeDeprogramacion}`);
...
let numero = prompt("Ingresa un número Aqui:");
...
console.log(`Número aleatorio generado: ${numeroAletorio}`);

*/

/* 12. Utiliza Math.random para generar un número entero entre 1 y 10 y muestra ese número en la consola.
 
let numeroAletorio = Math.floor(Math.random() * 10) + 1;
console.log(`Número aleatorio generado: ${numeroAletorio}`);
*/
/* 13. Utiliza Math.random para generar un número entero entre 1 y 1000 y muestra ese número en la consola.
 */
let numeroAletorio = Math.floor(Math.random()  *1000 ) +1;
console.log(`Número aleatorio generado: ${numeroAletorio}`);